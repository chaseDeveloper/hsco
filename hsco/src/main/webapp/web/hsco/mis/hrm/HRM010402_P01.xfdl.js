    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HRM010402_P01");
                this.set_classname("HRM010402_P01");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"EMPL_SE\" type=\"STRING\" size=\"256\"/><Column id=\"EMPNO\" type=\"STRING\" size=\"256\"/><Column id=\"EMPNM\" type=\"STRING\" size=\"256\"/><Column id=\"CLSF_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"JSSFC_SE\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"CLSF_SE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("HRM010402_P01.xfdl", "lib::comInclude.xjs");
        this.registerScript("HRM010402_P01.xfdl", function() {
        /***********************************************************************
         * 01. 업무구분 : 대상자조회
         * 02. 화면명   : HRM010402_P01.xfdl
         * 03. 화면설명 : 대상자(후보자)정보를 조회한다.
         * 04. 작성일   : 2015.06.29
         * 05. 작성자   : 이동석
         ...
         * 설명: 폼로딩시 처리
         ************************************************************************/
        this.HRM010402_P01_onload = function(obj,e)
        {
        ...
        this.fn_search= function()
        {
            ...
            var sController   	= "hsco/mis/hrm/HRM010402/selectEmpnoList.do";
        ...
        ***********************************************************************************/
        ...
        {
            this.addEventHandler("onload", this.HRM010402_P01_onload, this);
        ...
        this.loadIncludeScript("HRM010402_P01.xfdl");
