    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HRM030403_T03");
                this.set_classname("HRM030403");
                this.set_titletext("현보직근무연수");
            ...
            obj = new Grid("grd_nowAppntWorkYycntList", "absolute", "0", "68", null, null, "0", "0", this);
            obj.set_taborder("1");
            obj.set_binddataset("ds_nowAppntWorkYycntList");
            obj.set_autoenter("select");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"부서\"/><Cell col=\"2\" text=\"직종\"/><Cell col=\"3\" text=\"직급\"/><Cell col=\"4\" text=\"직위\"/><Cell col=\"5\" text=\"직렬\"/><Cell col=\"6\" text=\"사번\"/><Cell col=\"7\" text=\"성명\"/><Cell col=\"8\" text=\"생년월일\"/><Cell col=\"9\" text=\"입사일자\"/><Cell col=\"10\" text=\"현보직임용일자\"/><Cell col=\"11\" text=\"현보직 근무연수\"/></Band><Band id=\"body\"><Cell text=\"expr:currow + 1\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:DEPT_NM\"/><Cell col=\"2\" displaytype=\"combo\" text=\"bind:JSSFC_SE\" combodataset=\"ds_jssfcSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"3\" displaytype=\"combo\" text=\"bind:HR_CLSF_SE\" combodataset=\"ds_hrClsfSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"4\" displaytype=\"combo\" text=\"bind:OFCPS_SE\" combodataset=\"ds_ofcpsSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"5\" displaytype=\"combo\" text=\"bind:JBLN_SE\" combodataset=\"ds_jblnSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"6\" text=\"bind:EMPNO\"/><Cell col=\"7\" text=\"bind:EMPNM\"/><Cell col=\"8\" displaytype=\"date\" text=\"bind:BRTHDY\" calendardisplaynulltype=\"none\"/><Cell col=\"9\" displaytype=\"date\" text=\"bind:ECNY_DE\" calendardisplaynulltype=\"none\"/><Cell col=\"10\" displaytype=\"date\" text=\"bind:GNFD_DE\" calendardisplaynulltype=\"none\"/><Cell col=\"11\" style=\"align:left;\" text=\"expr:(YEAR != null ? YEAR+' ' : '')+(MT != null ? MT : '')\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_nowAppntWorkYycnt", "absolute", "0", "47", "173", "19", null, null, this);
            obj.set_taborder("3");
            obj.set_text("현보직근무연수");
            ...
            obj = new BindItem("item1","div_search.cmb_sttusSe","value","ds_nowAppntWorkYycntCond","STTUS_SE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item0","div_search.edt_empnm","value","ds_nowAppntWorkYycntCond","EMPNM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("HRM030403_T03.xfdl", "lib::comInclude.xjs");
        this.registerScript("HRM030403_T03.xfdl", function() {
        ...
        */
        this.grd_nowAppntWorkYycntList_onheadclick = function(obj,e)
        {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.grd_nowAppntWorkYycntList.addEventHandler("onheadclick", this.grd_nowAppntWorkYycntList_onheadclick, this);
        ...
        this.loadIncludeScript("HRM030403_T03.xfdl");
