(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"EMPNO\" type=\"STRING\" size=\"256\"/><Column id=\"EMPNM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"HR_CLSF_SE\" type=\"STRING\" size=\"256\"/><Column id=\"SORT_ORDR\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"72\"/><Column size=\"125\"/><Column size=\"122\"/><Column size=\"88\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"사번\"/><Cell col=\"2\" text=\"성명\"/><Cell col=\"3\" text=\"부서명\"/><Cell col=\"4\" text=\"직급\"/></Band><Band id=\"body\"><Cell text=\"expr:currow + 1\"/><Cell col=\"1\" text=\"bind:EMPNO\"/><Cell col=\"2\" text=\"bind:EMPNM\"/><Cell col=\"3\" text=\"bind:DEPT_NM\"/><Cell col=\"4\" displaytype=\"combo\" text=\"bind:HR_CLSF_SE\" combodataset=\"ds_clsfSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" text=\"계\"/><Cell col=\"2\" text=\"expr:dataset.getRowCount() + ' 명'\"/><Cell col=\"3\"/><Cell col=\"4\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("HRM010403_T2.xfdl", "lib::comInclude.xjs");
        this.addIncludeScript("HRM010403_T2.xfdl", "mis_lib::misUtil.xjs");
        this.registerScript("HRM010403_T2.xfdl", function() {
        /***********************************************************************
         * 화면ID   : HRM010403_T2.xfdl
         * 화면명   : 부서장미추천자 현황
         * 화면설명 : 
         * 작성일   : 2015.06.24
         * 작성자   : 박병일
         ...
         * onInit / onLoad 영역
         ***********************************************************************/
        this.HRM010403_T2_oninit = function(obj,e)
        {
        	// Form 초기화
        	this.fn_init_form();
        	// DataSet 초기화
        ...
        this.HRM010403_T2_onload = function(obj,e)
        {
        ...
        this.fn_transaction = function(strSvcId)
        {
        	switch (strSvcId) {
        		case "mainSearchList": // List 불러오기
        			var sController   	= "hsco/mis/hrm/HRM010403T02/mainSearchList.do";		
        ...
        ************************************************************************/
        ...
        {
            this.addEventHandler("oninit", this.HRM010403_T2_oninit, this);
            this.addEventHandler("onload", this.HRM010403_T2_onload, this);

        };

        this.loadIncludeScript("HRM010403_T2.xfdl");
