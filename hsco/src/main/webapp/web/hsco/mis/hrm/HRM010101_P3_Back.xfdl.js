(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"DEPT_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM2\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_SE\" type=\"STRING\" size=\"256\"/><Column id=\"UPPER_DEPT_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"LVL\" type=\"STRING\" size=\"256\"/><Column id=\"TEAM_CNT\" type=\"STRING\" size=\"256\"/><Column id=\"EMPNO\" type=\"STRING\" size=\"256\"/><Column id=\"EMPNM\" type=\"STRING\" size=\"256\"/><Column id=\"JSSFC_SE\" type=\"STRING\" size=\"256\"/><Column id=\"JSSFC_SE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"HR_CLSF_SE\" type=\"STRING\" size=\"256\"/><Column id=\"HR_CLSF_SE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"RSPOFC_SE\" type=\"STRING\" size=\"256\"/><Column id=\"RSPOFC_SE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"LXTN_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"TEAM_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"EMPNO\" type=\"STRING\" size=\"256\"/><Column id=\"EMPNM\" type=\"STRING\" size=\"256\"/><Column id=\"JSSFC_SE\" type=\"STRING\" size=\"256\"/><Column id=\"JSSFC_SE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"HR_CLSF_SE\" type=\"STRING\" size=\"256\"/><Column id=\"HR_CLSF_SE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"RSPOFC_SE\" type=\"STRING\" size=\"256\"/><Column id=\"RSPOFC_SE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"LXTN_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("Grid00", "absolute", "58", "160", "111", "97", null, null, this);
            obj.set_taborder("36");
            obj.set_binddataset("ds_cond_pop");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row band=\"body\" size=\"24\"/></Rows><Band id=\"head\"><Cell col=\"0\" disptype=\"normal\" text=\"DEPT_CODE\"/></Band><Band id=\"body\"><Cell col=\"0\" disptype=\"normal\" text=\"bind:DEPT_CODE\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01", "absolute", "178", "116", "861", "107", null, null, this);
            obj.set_taborder("37");
            obj.set_binddataset("ds_deptCode");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row band=\"body\" size=\"24\"/></Rows><Band id=\"head\"><Cell col=\"0\" disptype=\"normal\" text=\"DEPT_CODE\"/><Cell col=\"1\" disptype=\"normal\" text=\"DEPT_NM\"/><Cell col=\"2\" disptype=\"normal\" text=\"DEPT_NM2\"/><Cell col=\"3\" disptype=\"normal\" text=\"DEPT_SE\"/><Cell col=\"4\" disptype=\"normal\" text=\"UPPER_DEPT_CODE\"/><Cell col=\"5\" disptype=\"normal\" text=\"LVL\"/><Cell col=\"6\" disptype=\"normal\" text=\"TEAM_CNT\"/><Cell col=\"7\" disptype=\"normal\" text=\"EMPNO\"/><Cell col=\"8\" disptype=\"normal\" text=\"EMPNM\"/><Cell col=\"9\" disptype=\"normal\" text=\"JSSFC_SE\"/><Cell col=\"10\" disptype=\"normal\" text=\"JSSFC_SE_NM\"/><Cell col=\"11\" disptype=\"normal\" text=\"HR_CLSF_SE\"/><Cell col=\"12\" disptype=\"normal\" text=\"HR_CLSF_SE_NM\"/><Cell col=\"13\" disptype=\"normal\" text=\"RSPOFC_SE\"/><Cell col=\"14\" disptype=\"normal\" text=\"RSPOFC_SE_NM\"/><Cell col=\"15\" disptype=\"normal\" text=\"LXTN_NO\"/></Band><Band id=\"body\"><Cell col=\"0\" disptype=\"normal\" text=\"bind:DEPT_CODE\"/><Cell col=\"1\" disptype=\"normal\" text=\"bind:DEPT_NM\"/><Cell col=\"2\" disptype=\"normal\" text=\"bind:DEPT_NM2\"/><Cell col=\"3\" disptype=\"normal\" text=\"bind:DEPT_SE\"/><Cell col=\"4\" disptype=\"normal\" text=\"bind:UPPER_DEPT_CODE\"/><Cell col=\"5\" disptype=\"normal\" text=\"bind:LVL\"/><Cell col=\"6\" disptype=\"normal\" text=\"bind:TEAM_CNT\"/><Cell col=\"7\" disptype=\"normal\" text=\"bind:EMPNO\"/><Cell col=\"8\" disptype=\"normal\" text=\"bind:EMPNM\"/><Cell col=\"9\" disptype=\"normal\" text=\"bind:JSSFC_SE\"/><Cell col=\"10\" disptype=\"normal\" text=\"bind:JSSFC_SE_NM\"/><Cell col=\"11\" disptype=\"normal\" text=\"bind:HR_CLSF_SE\"/><Cell col=\"12\" disptype=\"normal\" text=\"bind:HR_CLSF_SE_NM\"/><Cell col=\"13\" disptype=\"normal\" text=\"bind:RSPOFC_SE\"/><Cell col=\"14\" disptype=\"normal\" text=\"bind:RSPOFC_SE_NM\"/><Cell col=\"15\" disptype=\"normal\" text=\"bind:LXTN_NO\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid02", "absolute", "176", "238", "861", "123", null, null, this);
            obj.set_taborder("38");
            obj.set_binddataset("ds_teamCode");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row band=\"body\" size=\"24\"/></Rows><Band id=\"head\"><Cell col=\"0\" disptype=\"normal\" text=\"DEPT_CODE\"/><Cell col=\"1\" disptype=\"normal\" text=\"TEAM_CODE\"/><Cell col=\"2\" disptype=\"normal\" text=\"TEAM_NM\"/><Cell col=\"3\" disptype=\"normal\" text=\"TEAM_NM2\"/><Cell col=\"4\" disptype=\"normal\" text=\"UPPER_TEAM_CODE\"/><Cell col=\"5\" disptype=\"normal\" text=\"USE_AT\"/></Band><Band id=\"body\"><Cell col=\"0\" disptype=\"normal\" text=\"bind:DEPT_CODE\"/><Cell col=\"1\" disptype=\"normal\" text=\"bind:TEAM_CODE\"/><Cell col=\"2\" disptype=\"normal\" text=\"bind:TEAM_NM\"/><Cell col=\"3\" disptype=\"normal\" text=\"bind:TEAM_NM2\"/><Cell col=\"4\" disptype=\"normal\" text=\"bind:UPPER_TEAM_CODE\"/><Cell col=\"5\" disptype=\"normal\" text=\"bind:USE_AT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid03", "absolute", "172", "380", "853", "111", null, null, this);
            obj.set_taborder("39");
            obj.set_binddataset("ds_teamConstnt");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row band=\"body\" size=\"24\"/></Rows><Band id=\"head\"><Cell col=\"0\" disptype=\"normal\" text=\"CHK\"/><Cell col=\"1\" disptype=\"normal\" text=\"DEPT_CODE\"/><Cell col=\"2\" disptype=\"normal\" text=\"TEAM_CODE\"/><Cell col=\"3\" disptype=\"normal\" text=\"EMPNO\"/><Cell col=\"4\" disptype=\"normal\" text=\"EMPNM\"/><Cell col=\"5\" disptype=\"normal\" text=\"JSSFC_SE\"/><Cell col=\"6\" disptype=\"normal\" text=\"JSSFC_SE_NM\"/><Cell col=\"7\" disptype=\"normal\" text=\"HR_CLSF_SE\"/><Cell col=\"8\" disptype=\"normal\" text=\"HR_CLSF_SE_NM\"/><Cell col=\"9\" disptype=\"normal\" text=\"RSPOFC_SE\"/><Cell col=\"10\" disptype=\"normal\" text=\"RSPOFC_SE_NM\"/><Cell col=\"11\" disptype=\"normal\" text=\"LXTN_NO\"/></Band><Band id=\"body\"><Cell col=\"0\" disptype=\"normal\" text=\"bind:CHK\"/><Cell col=\"1\" disptype=\"normal\" text=\"bind:DEPT_CODE\"/><Cell col=\"2\" disptype=\"normal\" text=\"bind:TEAM_CODE\"/><Cell col=\"3\" disptype=\"normal\" text=\"bind:EMPNO\"/><Cell col=\"4\" disptype=\"normal\" text=\"bind:EMPNM\"/><Cell col=\"5\" disptype=\"normal\" text=\"bind:JSSFC_SE\"/><Cell col=\"6\" disptype=\"normal\" text=\"bind:JSSFC_SE_NM\"/><Cell col=\"7\" disptype=\"normal\" text=\"bind:HR_CLSF_SE\"/><Cell col=\"8\" disptype=\"normal\" text=\"bind:HR_CLSF_SE_NM\"/><Cell col=\"9\" disptype=\"normal\" text=\"bind:RSPOFC_SE\"/><Cell col=\"10\" disptype=\"normal\" text=\"bind:RSPOFC_SE_NM\"/><Cell col=\"11\" disptype=\"normal\" text=\"bind:LXTN_NO\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid04", "absolute", "60", "514", "979", "180", null, null, this);
            obj.set_taborder("40");
            obj.set_binddataset("ds_data");
        ...
        // User Script
        this.addIncludeScript("HRM010101_P3_Back.xfdl", "lib::comInclude.xjs");
        this.addIncludeScript("HRM010101_P3_Back.xfdl", "mis_lib::misUtil.xjs");
        this.registerScript("HRM010101_P3_Back.xfdl", function() {
        /**********************************************************************
        ...
        this.fn_transaction = function(strSvcId)
        {
        	switch (strSvcId) {
        		case "select":		// 부서 조회
        			...
        			var sOutDatasets  	= "ds_deptCode=output1 ds_teamCode=output2 ds_teamConstnt=output3";
        			break;
        	}
        ...
        ***********************************************************************/
        ...
        try {
        	...
        	for(var dRow = 0; dRow < this.ds_deptCode.getRowCount(); dRow++) {
        		...
        		var cellVal   = jssfcSe + " " + clsfSe + enter + rspofcSe + enter + empnm + enter + lxtnNo;
        		if(!empno) {
        			cellVal = "";
        		}
        		...
        		if(teamCnt > 0) {
        			for(var tRow = 0; tRow < this.ds_teamCode.getRowCount(); tRow++) {
        				...
        				if(deptCode == deptCode2) {
        					...
        					this.grd.setCellProperty("Head", bCol, "text", deptNm);
        					this.grd.setCellProperty("Head", bCol + this.grd.getFormatColCount(), "text", cellVal);
        					this.grd.setCellProperty("Head", bCol + this.grd.getFormatColCount()*2, "text", teamNm);
        			...
        			this.grd.setCellProperty("Head", aCol, "text", deptNm);
        			this.grd.setCellProperty("Head", aCol + this.grd.getFormatColCount(), "text", cellVal);
        	...
        	// step3 : Cell Merge
        	var stIdx = -1;
        	for(var mRow = this.grd.getFormatColCount()-1; mRow >= 0; mRow--) {
        		...
        		if(this.comUtils.isNullEmpty(bfText) && stIdx != -1) {
        			this.grd.mergeContentsCell("Head", 1, mRow, 1, stIdx, mRow + this.grd.getFormatColCount(), false);
        			this.grd.mergeContentsCell("Head", 0, mRow, 0, stIdx, mRow, false);
        			stIdx = -1;
        		}
        	}
        ...
        {
        	this.fn_expExcel(this.grd, "excelFile");
        }
        ...
        this.loadIncludeScript("HRM010101_P3_Back.xfdl");
