    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HRM030403_T02");
                this.set_classname("HRM030403");
                this.set_titletext("자격증현황");
            ...
            obj = new Static("sta_crqfcStats", "absolute", "0", "47", "173", "19", null, null, this);
            obj.set_taborder("1");
            obj.set_text("자격증 목록");
            ...
            obj = new Grid("grd_qualfSttusList", "absolute", "270", "68", null, null, "0", "0", this);
            obj.set_taborder("3");
            obj.set_binddataset("ds_qualfSttusList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"60\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"150\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"부서\"/><Cell col=\"2\" text=\"직종\"/><Cell col=\"3\" text=\"직급\"/><Cell col=\"4\" text=\"직위\"/><Cell col=\"5\" text=\"직렬\"/><Cell col=\"6\" text=\"사원번호\"/><Cell col=\"7\" text=\"사원명\"/><Cell col=\"8\" text=\"자격증명\"/><Cell col=\"9\" text=\"등급\"/><Cell col=\"10\" text=\"취득일\"/><Cell col=\"11\" text=\"유효일자\"/><Cell col=\"12\" text=\"발급기관\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:DEPT_NM\"/><Cell col=\"2\" displaytype=\"combo\" text=\"bind:JSSFC_SE\" combodataset=\"ds_jssfcSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"3\" displaytype=\"combo\" text=\"bind:HR_CLSF_SE\" combodataset=\"ds_hrClsfSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"4\" displaytype=\"combo\" text=\"bind:OFCPS_SE\" combodataset=\"ds_ofcpsSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"5\" displaytype=\"combo\" text=\"bind:JBLN_SE\" combodataset=\"ds_jblnSe\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"6\" text=\"bind:EMPNO\"/><Cell col=\"7\" text=\"bind:EMPNM\"/><Cell col=\"8\" displaytype=\"combo\" style=\"align:left;\" text=\"bind:QUALF_CODE\" combodataset=\"ds_qualfCode\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"9\" displaytype=\"combo\" text=\"bind:QUALF_GRAD\" combodataset=\"ds_qualfGrad\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"10\" displaytype=\"date\" text=\"bind:ACQS_DE\" calendardisplaynulltype=\"none\"/><Cell col=\"11\" displaytype=\"date\" text=\"bind:VALID_DE\" calendardisplaynulltype=\"none\"/><Cell col=\"12\" style=\"align:left;\" text=\"bind:PBLICTE_OFFIC_NM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("sta_crqfcNmprSttus", "absolute", "270", "47", "173", "19", null, null, this);
            obj.set_taborder("4");
            obj.set_text("자격증별인원현황");
            obj.set_cssclass("sta_WF_Title02");
            this.addChild(obj.name, obj);

            obj = new Static("Static06", "absolute", "0", "64", null, "5", "0", null, this);
            obj.set_taborder("5");
            obj.set_text("5");
            obj.set_visible("false");
            obj.style.set_background("#dc143c3c");
            ...
            obj.style.set_background("#00ffff66");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("sta_qualfNm", "absolute", "406", "5", "75", "21", null, null, this.div_search);
            obj.set_taborder("9");
            obj.set_text("자격증명");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_qualfNm", "absolute", "471", "5", "200", "21", null, null, this.div_search);
            obj.set_taborder("10");
            this.div_search.addChild(obj.name, obj);

            obj = new Grid("grd_crqfcStats", "absolute", "0", "68", "260", null, null, "0", this);
            obj.set_taborder("0");
            obj.set_binddataset("ds_crqfcStats");
            obj.set_autoenter("none");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"170\"/><Column size=\"45\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"자격증명\"/><Cell col=\"2\" text=\"인원수\"/></Band><Band id=\"body\"><Cell text=\"expr:dataset.getColumn(currow,&quot;QUALF_NM&quot;) == &quot;전체&quot; ? &quot;&quot; : currow\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:QUALF_NM\"/><Cell col=\"2\" text=\"bind:EMP_CNT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item2","div_search.edt_qualfNm","value","ds_qualfSttusCond","QUALF_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","div_search.cmb_sttusSe","value","ds_qualfSttusCond","STTUS_SE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item0","div_search.edt_empnm","value","ds_qualfSttusCond","EMPNM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("HRM030403_T02.xfdl", "lib::comInclude.xjs");
        this.registerScript("HRM030403_T02.xfdl", function() {
        //include "lib::comInclude.xjs";

        /*
        * 함수명		: grd_crqfcStats_onheadclick
        * 설명			: 헤드클릭 정렬
        * params		: None
        * return Type	: None
        * 사용법		: this.grd_crqfcStats_onheadclick();
        */
        this.grd_crqfcStats_onheadclick = function(obj,e)
        {
        	this.fn_gridSort(obj, e, this.parent.parent.ds_crqfcStats);
        }

        /*
        * 함수명		: grd_qualfSttusList_onheadclick
        * 설명			: 헤드클릭 정렬
        * params		: None
        * return Type	: None
        * 사용법		: this.grd_qualfSttusList_onheadclick();
        */
        this.grd_qualfSttusList_onheadclick = function(obj,e)
        {
        	this.fn_gridSort(obj, e, this.parent.parent.ds_qualfSttusList);
        }
        ...
        */
        ...
        {
        	this.gfn_exportExcel(this.grd_qualfSttusList, "exportExl");
        }
        });
        ...
        {
            this.grd_qualfSttusList.addEventHandler("onheadclick", this.grd_qualfSttusList_onheadclick, this);
            this.div_search.cmb_sttusSe.addEventHandler("onitemchanged", this.div_search_cmb_dgriSe_onitemchanged, this);
            this.grd_crqfcStats.addEventHandler("onheadclick", this.grd_crqfcStats_onheadclick, this);
            this.btn_excel_down.addEventHandler("onclick", this.btn_excel_down_onclick, this);

        };

        this.loadIncludeScript("HRM030403_T02.xfdl");
