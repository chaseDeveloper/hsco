 ...
 * @Class Name   	: PRJ040304Controller.java
 * @Description  	: 용역성과품 컨트롤러 클래스 
 * @author       	: 
 * @since        	: 
 * @version      	: 
 * @see          	: 
...
@Controller
public class PRJ040304Controller extends BaseContoller {

	@Resource(name="PRJ040304Service")
	PRJ040304ServiceImpl svc;

	//  조회
	@RequestMapping("hsco/pms/prj/PRJ040304/mList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ040304/rList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ040304/r2List.do")
	...
	//  저장
	@RequestMapping("hsco/pms/prj/PRJ040304/save.do")
