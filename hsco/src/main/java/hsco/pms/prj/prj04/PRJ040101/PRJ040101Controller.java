 ...
 * @Class Name   	: PRJ040101Controller.java
 * @Description  	: 표준업무분류코드 컨트롤러 클래스 
 * @author       	: 
 * @since        	: 
 * @version      	: 
 * @see          	: 
...
@Controller
public class PRJ040101Controller extends BaseContoller {

	@Resource(name="PRJ040101Service")
	PRJ040101ServiceImpl svc;

	//  조회
	@RequestMapping("hsco/pms/prj/PRJ040101/mList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ040101/rList.do")
	...
	//  저장
	@RequestMapping("hsco/pms/prj/PRJ040101/save.do")
	...
	// 코드복사
	@RequestMapping("hsco/pms/prj/PRJ040101/copy.do")
