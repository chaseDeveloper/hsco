package hsco.pms.prj.prj03.PRJ030101;
...
@Service("PRJ030101Service")
public class PRJ030101ServiceImpl extends BaseService {
	...
	public void mList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		outDsMap.setRowMaps((List<Map>)baseDao.list("PRJ030101.mList", inMap));
	...
	public void rList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("PRJ030101.rList", inMap));
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED :
					baseDao.insert("PRJ030101.mC", map);
					break;
				case DataSet.ROW_TYPE_UPDATED :
					iRow += baseDao.update("PRJ030101.mU", map);
					break;
				case DataSet.ROW_TYPE_DELETED :
					baseDao.delete("PRJ030101.rD", map);
					iRow += baseDao.delete("PRJ030101.mD", map);
					break;
			}
		}
		return iRow;
	...
	public int rSave( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED :
					baseDao.insert("PRJ030101.rC", map);
					break;
				case DataSet.ROW_TYPE_UPDATED :
					iRow += baseDao.update("PRJ030101.rU", map);
					break;
				case DataSet.ROW_TYPE_DELETED :
					iRow += baseDao.delete("PRJ030101.rD", map);
					break;
			}
		}
		return iRow;
