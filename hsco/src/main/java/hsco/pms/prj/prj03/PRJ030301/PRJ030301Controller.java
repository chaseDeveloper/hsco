 ...
 * @Class Name   	: PRJ030301Controller.java
 * @Description  	: 준공원가집계 컨트롤러 클래스 
 * @author       	: 
 * @since        	: 
 * @version      	: 
 * @see          	: 
...
@Controller
public class PRJ030301Controller extends BaseContoller {

	@Resource(name="PRJ030301Service")
	PRJ030301ServiceImpl svc;

	//  조회
	@RequestMapping("hsco/pms/prj/PRJ030301/mList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ030301/rList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ030301/r2List.do")
	...
	//  생성
	@RequestMapping("hsco/pms/prj/PRJ030301/make.do")
