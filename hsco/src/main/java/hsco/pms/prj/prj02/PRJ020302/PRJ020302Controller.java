package hsco.pms.prj.prj02.PRJ020302;
 ...
 * @Class Name   	: PRJ020302Controller.java
...
@Controller
public class PRJ020302Controller extends BaseContoller {

	@Resource(name="PRJ020302Service")
	PRJ020302ServiceImpl svc;

	//  조회
	@RequestMapping("hsco/pms/prj/PRJ020302/mList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ020302/rList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ020302/r2List.do")
	...
	//  저장
	@RequestMapping("hsco/pms/prj/PRJ020302/save.do")
	...
	//  생성
	@RequestMapping("hsco/pms/prj/PRJ020302/make.do")
