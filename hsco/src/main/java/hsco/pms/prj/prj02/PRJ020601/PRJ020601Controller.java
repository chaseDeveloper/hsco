 ...
 * @Class Name   	: PRJ020601Controller.java
...
@Controller
public class PRJ020601Controller extends BaseContoller {

	@Resource(name="PRJ020601Service")
	PRJ020601ServiceImpl svc;

	//  조회
	@RequestMapping("hsco/pms/prj/PRJ020601/mList.do")
	...
	//  저장
	@RequestMapping("hsco/pms/prj/PRJ020601/save.do")
	...
	//  생성
	@RequestMapping("hsco/pms/prj/PRJ020601/make.do")
