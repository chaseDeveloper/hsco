...
@Service("PRJ050102Service")
public class PRJ050102ServiceImpl extends BaseService {
	...
	public void mList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		outDsMap.setRowMaps((List<Map>)baseDao.list("PRJ050102.mList", inMap));
	...
	public void rList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("PRJ050102.rList", inMap));
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED :
					baseDao.insert("PRJ050102.mC", map);
					break;
				case DataSet.ROW_TYPE_UPDATED :
					iRow += baseDao.update("PRJ050102.mU", map);
					break;
				case DataSet.ROW_TYPE_DELETED :
					iRow += baseDao.delete("PRJ050102.mD", map);
					break;
			}
		}
		return iRow;
	...
	public int rSave( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED :
					baseDao.insert("PRJ050102.rC", map);
					break;
				case DataSet.ROW_TYPE_UPDATED :
					iRow += baseDao.update("PRJ050102.rU", map);
					break;
				case DataSet.ROW_TYPE_DELETED :
					iRow += baseDao.delete("PRJ050102.rD", map);
					break;
			}
		}
		return iRow;
