...
@Service("PRJ050601Service")
public class PRJ050601ServiceImpl extends BaseService {
	...
	public void mList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		outDsMap.setRowMaps((List<Map>)baseDao.list("PRJ050601.mList", inMap));
	...
	public void rList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("PRJ050601.rList", inMap));
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED :
					baseDao.insert("PRJ050601.mC", map);
					break;
				case DataSet.ROW_TYPE_UPDATED :
					iRow += baseDao.update("PRJ050601.mU", map);
					break;
				case DataSet.ROW_TYPE_DELETED :
					iRow += baseDao.delete("PRJ050601.mD", map);
					break;
			}
		}
		return iRow;
