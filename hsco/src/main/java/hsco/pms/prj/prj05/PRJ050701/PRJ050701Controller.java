 ...
 * @Class Name   	: PRJ050701Controller.java
 * @Description  	: 일위대가 컨트롤러 클래스 
 * @author       	: 
 * @since        	: 
 * @version      	: 
 * @see          	: 
...
@Controller
public class PRJ050701Controller extends BaseContoller {

	@Resource(name="PRJ050701Service")
	PRJ050701ServiceImpl svc;

	//  조회
	@RequestMapping("hsco/pms/prj/PRJ050701/mList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ050701/rList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ050701/xlsList.do")
	...
	//  저장
	@RequestMapping("hsco/pms/prj/PRJ050701/save.do")
	...
	// 엑셀 저장
	@RequestMapping("hsco/pms/prj/PRJ050701/xSave.do")
