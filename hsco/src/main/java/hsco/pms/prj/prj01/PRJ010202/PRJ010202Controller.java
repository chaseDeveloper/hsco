package hsco.pms.prj.prj01.PRJ010202;
 ...
 * @Class Name   	: PRJ010202Controller.java
 * @Description  	: 사업비계획집계 컨트롤러 클래스 
 * @author       	: 
 * @since        	: 
 * @version      	: 
 * @see          	: 
...
@Controller
public class PRJ010202Controller extends BaseContoller {

	@Resource(name="PRJ010202Service")
	PRJ010202ServiceImpl svc;

	//  조회
	@RequestMapping("hsco/pms/prj/PRJ010202/mList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ010202/rList.do")
	...
	//  조회
	@RequestMapping("hsco/pms/prj/PRJ010202/r2List.do")
	...
	//  생성
	@RequestMapping("hsco/pms/prj/PRJ010202/make.do")
