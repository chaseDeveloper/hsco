...
@Service("PRJ010101Service")
public class PRJ010101ServiceImpl extends BaseService {
	...
	public void selectDsMain(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		outDsMap.setRowMaps((List<Map>) baseDao.list("PRJ010101DAO.selectDs_Main", inMap));
		...
		for (int x = 0; x < list1.size(); x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_INSERTED:
					baseDao.insert("PRJ010101DAO.insertDs_Main", map);
					break;
				case DataSet.ROW_TYPE_UPDATED:
					baseDao.update("PRJ010101DAO.updateDs_Main", map);
					break;
				case DataSet.ROW_TYPE_DELETED:
					baseDao.delete("PRJ010101DAO.deleteDs_Main", map);
					break;
			}
		}
	}
