package hsco.pms.fms.FMS020101;
...
@Service("FMS020101Service")
public class FMS020101ServiceImpl extends BaseService {
	...
	public void select(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		outDsMap.setRowMaps((List<Map>) baseDao.list("FMS020101DAO.selectFcltsList", inMap));
	...
	public void selectSub(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		outDsMap1.setRowMaps((List<Map>) baseDao.list("FMS020101DAO.selectReprsntFcltsManage", inMap));
		outDsMap2.setRowMaps((List<Map>) baseDao.list("FMS020101DAO.selectReprsntFcltsBild",   inMap));
		outDsMap3.setRowMaps((List<Map>) baseDao.list("FMS020101DAO.selectBildInnerFclty",     inMap));
		...
		for (int x = 0; x < list1.size(); x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_DELETED:
					baseDao.delete("FMS020101DAO.deleteReprsntFcltsManage", map);
					baseDao.delete("FMS020101DAO.deleteReprsntFcltsBild", map);
					baseDao.delete("FMS020101DAO.deleteBildInnerFclty", map);
					break;
			}
		}
		...
		for (int x = 0; x < list2.size(); x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_INSERTED:
					fcltsManageSn = (String) baseDao.select("FMS020101DAO.getFcltsManageSn", map);
					map.put("FCLTS_MANAGE_SN", fcltsManageSn);
					baseDao.insert("FMS020101DAO.insertReprsntFcltsManage", map);
					break;
				case DataSet.ROW_TYPE_UPDATED:
					baseDao.update("FMS020101DAO.updateReprsntFcltsManage", map);
					break;
			}
		}
		...
		for (int x = 0; x < list3.size(); x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_INSERTED:
					...
					baseDao.insert("FMS020101DAO.insertReprsntFcltsBild", map);
					break;
				case DataSet.ROW_TYPE_UPDATED:
					baseDao.update("FMS020101DAO.updateReprsntFcltsBild", map);
					break;
			}
		}
		...
		for (int x = 0; x < list4.size(); x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_INSERTED:
					...
					baseDao.insert("FMS020101DAO.insertBildInnerFclty", map);
					break;
				case DataSet.ROW_TYPE_UPDATED:
					baseDao.update("FMS020101DAO.updateBildInnerFclty", map);
					break;
				case DataSet.ROW_TYPE_DELETED:
					baseDao.delete("FMS020101DAO.deleteBildInnerFclty", map);
					break;
