...
@Service("FMS030102Service")
public class FMS030102ServiceImpl extends BaseService {
	...
	public void selectFcltsList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		outDsMap.setRowMaps((List<Map>) baseDao.list("FMS030102DAO.selectFcltsList", inMap));
	...
	public void selectCheckDgnssPlan(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>) baseDao.list("FMS030102DAO.selectCheckDgnssPlan", inMap));
		outDataset.put("output1", outDsMap);
	}
		...
		for (int x = 0; x < list1.size(); x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_INSERTED:
					baseDao.insert("FMS030102DAO.mendngReinfcPlanC", map);
					break;
				case DataSet.ROW_TYPE_UPDATED:
					baseDao.update("FMS030102DAO.mendngReinfcPlanU", map);
					break;
				case DataSet.ROW_TYPE_DELETED:
					baseDao.delete("FMS030102DAO.mendngReinfcPlanD", map);
					break;
			}
		}
	}
