 ...
 * @Class Name   	: RNT01051401ServiceImpl.java
 * @Description  	: 자동이체 신청정보 등록
 * @author       	: 김지훈
 * @since        	: 2015. 12. 21.
 * @version      	: 1.0
 * @see          	: 
 ...
 * </pre>  
 */
@Service("RNT01051401Service")
public class RNT01051401ServiceImpl extends BaseService{
	...
	public void selectAtcngReqstTrmnatList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inDsMap != null)
			inMap = inDsMap.get(0);
		List <Map> records = (List<Map>)baseDao.list("RNT01051401DAO.selectAtcngReqstTrmnatList", inMap);
	...
	public void selectAtcngReqstTrmnatListCnt( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inDsMap != null)
			inMap = inDsMap.get(0);
		List <Map> records = (List<Map>)baseDao.list("RNT01051401DAO.selectAtcngReqstTrmnatListCnt", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
	...
	public void selectAtcngReqstCntChck( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inDsMap != null)
			inMap = inDsMap.get(0);
		List <Map> records = (List<Map>)baseDao.list("RNT01051401DAO.selectAtcngReqstCntChck", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
		outDataset.put("output1", outDsMap);
	}
    ...
    public void uploadAtcngRqestList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset,
		...
		if(resultAt){
			...
			// 기존 해당 년월 데이터 삭제
			baseDao.delete("RNT01051401DAO.deleteAtcngInfo", inMap);
			...
			for(int i = 0; i < bodyListSize; i++){
				...
				*/
			    ...
			    if(inAtcngJobSe.equals("01")){ // 임대료일때만 영구/매입 같이처리
					// 매입임대료 , 영구임대료 구분
					List <Map> rentHoue = (List<Map>)baseDao.list("RNT01051401DAO.selectRentHouseInfo", bodyItem);
					...
					if(rentHouseSe.equals("00")){
						...
						if(rentHouseSe.equals("R1") || rentHouseSe.equals("R3") ){
						    ...
						    bodyItem.put("ATCNG_JOB_SE","04");
						}
					}
				}
				
				// 월별 자동이체 신청/해지정보 건별 등록
				baseDao.insert("RNT01051401DAO.insertAtcngReqstInfo", bodyItem);
	...
	public void saveAtcngReqstTrmnat(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("RNT01051401DAO.SPRNT_TBPMS_ATCNG_REQ_TR_IU", inMap);		
    ...
    public String getAtcngReqstFileContents(Map inMap) throws Exception
    {
    	...
    	// 헤더구성용
    	Map<String, Object> reqstDeInfo = (Map<String, Object>)baseDao.select("RNT01051401DAO.selectAtcngReqstDeInfo", inMap);

    	// 바디구성용
    	List<Map> bodyList = (List<Map>)baseDao.list("RNT01051401DAO.selectAtcngReqstTrmnatList", inMap);
    	...
    	buffer.append(StringUtil.rpad("2141430", ' ', 7));	// 헤더-기관코드('2140010'로 고정)
