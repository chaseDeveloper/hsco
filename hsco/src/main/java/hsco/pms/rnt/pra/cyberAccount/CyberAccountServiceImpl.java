 ...
 * @Class Name   	: CyberAccountServiceImpl.java
 * @Description  	: 가상계좌 팝업
 * @author       	: 지효정
 * @since        	: 2015. 10. 27.
 * @version      	: 1.0
 ...
 * </pre>  
 */
@Service("CyberAccountService")
public class CyberAccountServiceImpl extends BaseService{
	/**
	 * 미납 목록
	 * @param tranInfo
	 * @param inVar
	...
	public void nonPaymentList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("cyberAccountDAO.nonPaymentList", inMap);
	...
	public void receiptList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("cyberAccountDAO.receiptList", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
		outDataset.put("output1", outDsMap);
	} 
	...
	public void vacctNoList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inDsMap != null)
			inMap = inDsMap.get(0);
		List <Map> records = (List<Map>)baseDao.list("cyberAccountDAO.vacctNoList", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
		outDataset.put("output1", outDsMap);
	} 
	...
	public void billList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("cyberAccountDAO.billList", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
		outDataset.put("output1", outDsMap);
	} 
	...
	public void billDetailList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("cyberAccountDAO.billDetailList", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
		outDataset.put("output1", outDsMap);
	} 
	...
	public void spVaBillUid( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		baseDao.list("cyberAccountDAO.SP_VA_BILL_UID", map);
	...
	public void selectBillPrintList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inDsMap != null)
			inMap = inDsMap.get(0);
		List <Map> records = (List<Map>)baseDao.list("cyberAccountDAO.selectBillPrintList", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
		outDataset.put("output1", outDsMap);
	} 	
