 ...
 * @Class Name   		: RNT02031000ServiceImpl.java
 * @Description  		: 매임임대 주택소유
 * @author       			: 변승우
 * @since        			: 2015. 11. 26.
 * @version      			: 1.0
 * @see          			: 
...
@Service("RNT02031000Service")
public class RNT02031000ServiceImpl extends BaseService{
	...
	public void rentPosesnThingPopList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if ("1".equals(get_gubun)) {
			records = (List<Map>)baseDao.list("RNT02031000DAO.rentPosesnThingPopList", inMap);		// 전체 계약자 조회
		}
		else if ("2".equals(get_gubun)) {
			records = (List<Map>)baseDao.list("RNT02031000DAO.rentPosesnThingPopList2", inMap);		// 재계약자 조회
		}
		else if ("3".equals(get_gubun)) {
			records = (List<Map>)baseDao.list("RNT02031000DAO.rentPosesnThingPopList3", inMap);		// 입주대기자 조회
		}
