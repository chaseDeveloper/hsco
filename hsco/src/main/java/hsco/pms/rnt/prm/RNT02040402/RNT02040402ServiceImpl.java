 ...
 * @Class Name   	: RNT02040402ServiceImpl.java
...
@Service("RNT02040402Service")
public class RNT02040402ServiceImpl extends BaseService{
	...
	public void selectAtcngRqestRcivList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("RNT02040402DAO.selectAtcngRqestRcivList", inMap);
	 ...
	 */ 
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public void saveSlaryCUD(DataSetMap tranInfo, Map<String, Object> inVar,
			Map<String, DataSetMap> inDataset, Map<String, Object> outVar,
			Map<String, DataSetMap> outDataset) throws NexaServiceException {
		DataSetMap inDsMap = (DataSetMap)inDataset.get("input1");
		Map inMap = null;
		...
		records = (List<Map>)baseDao.list("RNT02040402DAO.SPRNT_PUCHAS_AUTOPAY_DEMAND_ID", inMap);		
    ...
    public String getAtcngReqstFileContents(Map inMap) throws Exception
    {
    	...
    	// 헤더구성용
    	Map<String, Object> reqstDeInfo = (Map<String, Object>)baseDao.select("RNT02040402DAO.getListHead", inMap);
       
    	// 바디구성용
    	List<Map> bodyList = (List<Map>)baseDao.list("RNT02040402DAO.getList", inMap);
	 ...
	 */ 
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public void selectAutopayDemandList( DataSetMap tranInfo, Map<String, Object> inVar,
			Map<String, DataSetMap> inDataset, Map<String, Object> outVar,
			Map<String, DataSetMap> outDataset) throws NexaServiceException {
		DataSetMap inDsMap = (DataSetMap)inDataset.get("input1");
		Map inMap = null;
		...
		List <Map> records = (List<Map>)baseDao.list("RNT02040402DAO.selectAutopayDemandList", inMap);
