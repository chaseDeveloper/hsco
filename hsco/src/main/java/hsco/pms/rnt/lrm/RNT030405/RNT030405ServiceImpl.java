...
@Service("RNT030405Service")
public class RNT030405ServiceImpl extends BaseService implements RNT030405Service {
	...
	public void getList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("RNT030405DAO.getList", inMap);		
	...
	public void print(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("RNT030405DAO.print", inMap);		
    ...
    public String getAtcngReqstFileContents(Map inMap) throws Exception
    {
    	...
    	// 헤더구성용
    	Map<String, Object> reqstDeInfo = (Map<String, Object>)baseDao.select("RNT030405DAO.getListHead", inMap);

    	// 바디구성용
    	List<Map> bodyList = (List<Map>)baseDao.list("RNT030405DAO.getList", inMap);
	...
	public void listCUD(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("RNT030405DAO.SP_RN_RENT_AUTOPAY_DEMAND_ID", inMap);		
