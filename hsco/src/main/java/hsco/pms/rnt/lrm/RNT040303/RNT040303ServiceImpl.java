...
@Service("RNT040303Service")
public class RNT040303ServiceImpl extends BaseService implements RNT040303Service {
	...
	public void getList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inMap != null) {
			records = (List<Map>)baseDao.list("RNT040303DAO.getList", inMap);
		} else {
			records = (List<Map>)baseDao.list("RNT040303DAO.getList", inVar);
		}
	...
	public void getList1(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inMap != null) {
			records = (List<Map>)baseDao.list("RNT040303DAO.getList1", inMap);
		} else {
			records = (List<Map>)baseDao.list("RNT040303DAO.getList1", inVar);
		}
	...
	public void listCUD(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < list.size(); x++) {
			...
			case DataSet.ROW_TYPE_INSERTED :
				iRow += baseDao.update("RNT040303DAO.listC", map);
				break;			
			case DataSet.ROW_TYPE_UPDATED :
				iRow += baseDao.update("RNT040303DAO.listU", map);
				break;
			case DataSet.ROW_TYPE_DELETED :
				iRow += baseDao.delete("RNT040303DAO.listD", map);
				break;
		...
		for (int x = 0; x < list.size(); x++) {
			...
			baseDao.insert("RNT040303DAO.listR1U", map);
	...
	public void approveU(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		baseDao.update("RNT040303DAO.approveU", map);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.add(map);
	...
	public void approveU2(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		baseDao.update("RNT040303DAO.approveU2", map);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.add(map);
	...
	public void atchCUD( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		try
		{
			if(upResult != null){				
				...
				baseDao.insert("RNT040303DAO.atchCUD", targetMap);
			}
    ...
    public void atchDelete(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (list != null){
			...
			if(fileCnt == 0)
			{
				...
				baseDao.delete("RNT040303DAO.atchDelete", inMap);
			}				
