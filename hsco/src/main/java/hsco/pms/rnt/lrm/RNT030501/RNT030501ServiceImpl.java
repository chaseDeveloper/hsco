...
@Service("RNT030501Service")
public class RNT030501ServiceImpl extends BaseService implements RNT030501Service {
	...
	public void getList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("RNT030501DAO.getList", inMap);		
	...
	public void getListR1(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("RNT030501DAO.getListR1", inMap);		
