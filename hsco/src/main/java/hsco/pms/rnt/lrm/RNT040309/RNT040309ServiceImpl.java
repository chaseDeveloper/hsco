 ...
 * @Class Name   	: RNT040309ServiceImpl.java
...
@Service("RNT040309Service")
public class RNT040309ServiceImpl extends BaseService implements RNT040309Service {
	...
	public void getList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("RNT040309DAO.getList", inMap);		
	...
	public void listCUD(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < list.size(); x++) {			
			Map map = list.get(x);			
			baseDao.update("RNT040309DAO.listC", map);
		}
	}
