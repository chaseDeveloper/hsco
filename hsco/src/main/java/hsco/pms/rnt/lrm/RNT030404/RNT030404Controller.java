 ...
 * @Class Name   	: RNT030404Controller.java
 * @Description  	: 
 * @author       	: 이광원
 * @since        	: 2015. 11. 4.
 * @version      	: 1.0
 ...
 */
@Controller
public class RNT030404Controller extends BaseContoller {
	private final Logger log = LoggerFactory.getLogger(this.getClass());
	@Resource(name="RNT030404Service")
	RNT030404ServiceImpl rnt030404Service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/hsco/pms/rnt/rnt030404/selectAtcngReqstList.do") 
	public ModelAndView selectAtcngRqestList(NexacroMapDTO xpDto, Model model) throws Exception {
		
		ModelAndView mav = new ModelAndView("nexacroMapView");
			
		execService(rnt030404Service, "selectAtcngReqstSumInfo", xpDto, mav);	// reqstSumInfo - 월별 자동이체 신청해지 결과 내역
		execService(rnt030404Service, "selectAtcngReqstList", xpDto, mav);		// reqstList - 월별 자동이체 신청해지 결과 목록 조회
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/hsco/pms/rnt/rnt030404/selectAtcngProcessCnt.do") 
	public ModelAndView selectAtcngProcessCnt(NexacroMapDTO xpDto, Model model) throws Exception {
		
		ModelAndView mav = new ModelAndView("nexacroMapView");
			
		execService(rnt030404Service, "selectAtcngProcessCnt", xpDto, mav);	// reqstCntInfo - 월별 자동이체 신청해지 처리 건수 조회
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/hsco/pms/rnt/rnt030404/uploadAtcngReqstFile.do")
	public ModelAndView uploadAtcngRqestList(NexacroMapDTO xpDto, Model model) throws Exception {

		ModelAndView mav = new ModelAndView("nexacroMapView");
		
		execService(rnt030404Service, "uploadAtcngRqestList", xpDto, mav);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/hsco/pms/rnt/rnt030404/downloadAtcngReqstFile.do")
	...
	public ModelAndView downloadAtcngRqestList(NexacroMapDTO xpDto, Model model) throws Exception {
		...
		File AtcngReqstFile = rnt030404Service.getAtcngReqstFile(xpDto);
