 ...
 * @Class Name   	: PMS000002Controller.java
 * @Description  	: 
 * @author       	: 이광원
 * @since        	: 2015. 11. 4.
 * @version      	: 1.0
 ...
 */
@Controller
public class PMS000002Controller extends BaseContoller {
	private final Logger log = LoggerFactory.getLogger(this.getClass());
	@Resource(name="PMS000002Service")
	PMS000002ServiceImpl PMS000002Service;
	/* 계약자 조회 */
	@RequestMapping("/hsco/pms/com/PMS000002/getList.do") 
	public ModelAndView getList(NexacroMapDTO xpDto, Model model) throws Exception {
		log.debug("계약자 조회 ----------------------------------------------------!");
		ModelAndView mav = new ModelAndView("nexacroMapView");
		
		execService(PMS000002Service, "getList", xpDto, mav);
	 ...
	 * 
	 */
	@RequestMapping("/hsco/pms/com/PMS000002/selectAtcngRqestRcivChk.do") 
	public ModelAndView selectAtcngRqestRcivChk(NexacroMapDTO xpDto, Model model) throws Exception {
		log.debug("출금결과 기등록 조회 ----------------------------------------------------!");
		ModelAndView mav = new ModelAndView("nexacroMapView");
		
		execService(PMS000002Service, "selectAtcngRqestRcivChk", xpDto, mav);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/hsco/pms/com/PMS000002/downloadAtcngReqstFile.do")
	...
	public ModelAndView downloadAtcngRqestList(NexacroMapDTO xpDto, Model model) throws Exception {
		...
		File AtcngReqstFile = PMS000002Service.getAtcngReqstFile(xpDto);
	...
	/* 출력물 조회 */
	@RequestMapping("/hsco/pms/com/PMS000002/print.do") 
	public ModelAndView print(NexacroMapDTO xpDto, Model model) throws Exception {
		log.debug("신청자 ----------------------------------------------------!");
		ModelAndView mav = new ModelAndView("nexacroMapView");
		
		execService(PMS000002Service, "print", xpDto, mav);
	...
	/* 청구파일생성 프로시저 호출 */
	@RequestMapping("/hsco/pms/com/PMS000002/listCUD.do")
	public ModelAndView listCUD1(NexacroMapDTO xpDto, Model model)
		...
		execService(PMS000002Service, "listCUD", xpDto, mav);
