package hsco.pms.com.PMS000002;
 ...
 * @Class Name   	: RNT030405ServiceImpl.java
 * @Description  	: 
 * @author       	: 이광원
 * @since        	: 2015. 11. 4.
 * @version      	: 1.0
...
@Service("PMS000002Service")
public class PMS000002ServiceImpl extends BaseService implements PMS000002Service {
	...
	public void getList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		System.out.println( ":: PAY_SE ::" + inMap.get("PAY_SE"));
		System.out.println( ":: DEFRAY_YM ::" + inMap.get("DEFRAY_YM"));
		
		records = (List<Map>)baseDao.list("PMS000002DAO.getList", inMap);	
    ...
    @SuppressWarnings({"unchecked","rawtypes"})
   	public void selectAtcngRqestRcivChk(DataSetMap tranInfo, Map<String, Object> inVar,
   		...
   		records = (List<Map>)baseDao.list("PMS000002DAO.selectAtcngRqestRcivChk", inMap);	
	...
	public void print(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		String val1 = (String)inMap.get("VAL1");
		String val3 = (String)inMap.get("VAL3");
			
		List <Map> records;

		records = (List<Map>)baseDao.list("PMS000002DAO.print", inMap);		
    ...
    public String getAtcngReqstFileContents(Map inMap) throws Exception
    {
    	...
    	// 헤더구성용
    	Map<String, Object> reqstDeInfo = (Map<String, Object>)baseDao.select("PMS000002DAO.getListHead", inMap);

    	// 바디구성용
    	List<Map> bodyList = (List<Map>)baseDao.list("PMS000002DAO.getList", inMap);
    	...
    	String val1 = (String)inMap.get("VAL1");	// 기관코드
    	
    	buffer.append(StringUtil.rpad("S5", ' ', 2));		// 헤더-데이터 구분('S'로 고정)
    	buffer.append(StringUtil.rpad("31", ' ', 2));		// 헤더-구분('15'로 고정)
    	buffer.append(StringUtil.rpad(val1, ' ', 6));	// 헤더-기관코드('2141430'로 고정)
    	buffer.append(StringUtil.rpad("0", ' ', 1));	// 
    	...
    	for(int i = 0; i < listSize; i++){
    		...
    		String Bank_Code = (String)bodyInfo.get("BANK_CODE2");			// 은행코드
    		...
    		String Defray_YM = (String)bodyInfo.get("DEFRAY_YM2");		// 해당출금년월
    		String Cptal_Se = (String)bodyInfo.get("CPTAL_SE");		// 자금구분
    		String Area_Se = (String)bodyInfo.get("AREA_SE");		// 주택코드
    		...
    		String Total_Amount = (String)bodyInfo.get("TOTAL_AMOUNT").toString();		// 출금의뢰금액 총액
    	...
    	Map bodyInfo = (Map)bodyList.get(0);
    	...
    	buffer.append(StringUtil.lpad(total_sum, '0', 13));						// 출금의뢰금액(13)
	...
	/*	System.out.println("::::IN_BILL_YM:::: " + inMap.get("IN_BILL_YM"));
		System.out.println("::::IN_REC_DATE:::: " + inMap.get("IN_REC_DATE"));
		System.out.println("::::IN_TRANS_YMD:::: " + inMap.get("IN_TRANS_YMD"));
		System.out.println("::::IN_REC_YMD:::: " + inMap.get("IN_REC_YMD"));
		System.out.println("::::IN_JOB_SE:::: " + inMap.get("IN_JOB_SE"));
		System.out.println("::::IN_PAY_SE:::: " + inMap.get("IN_PAY_SE"));
		*/
		records = (List<Map>)baseDao.list("PMS000002DAO.SPRNT_TBPMS_AUTOPAY_DEMAND_ID", inMap);		
