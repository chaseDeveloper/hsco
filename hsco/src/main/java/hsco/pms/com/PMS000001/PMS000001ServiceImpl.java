 ...
 * @Class Name   	: PMS000001ServiceImpl.java
 * @Description  	: 
 * @author       	: 이광원
 * @since        	: 2015. 11. 4.
 * @version      	: 1.0
...
@Service("PMS000001Service")
public class PMS000001ServiceImpl extends BaseService implements PMS000001Service {
	...
	public void selectAtcngReqstSumInfo(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset,
		...
		resMap = (Map)baseDao.select("PMS000001DAO.selectAtcngReqstSumInfo", inMap);
	...
	public void selectAtcngReqstList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset,
		...
		resList = (List<Map>)baseDao.list("PMS000001DAO.selectAtcngReqstList", inMap);
	...
	public void selectAtcngProcessCnt(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset,
		...
		resMap = (Map)baseDao.select("PMS000001DAO.selectAtcngProcessCnt", inMap);
    ...
    public void uploadAtcngRqestList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset,
		...
		if(resultAt){
			...
			String inPaySe = (String)inMap.get("PAY_SE");		// 납부구분
			...
			// 기존 해당 년월 데이터 삭제
			baseDao.delete("PMS000001DAO.deleteAtcngInfo", inMap);
			...
			String inTranDate = "20" + (String) headerMap.get("TRAN_DATE");
			String subTranDate  = inTranDate.substring(0, 6);
			
		//	System.out.println(("::::::INFO::::::: subTranDate :: " + subTranDate));
			
			String subReqstYm = inReqstYm.substring(0, 4) + "-" + inReqstYm.substring(4,6);
			
			if(! inReqstYm.equals(subTranDate)){
				String resultMsg = "해당 신청년월[ "+subReqstYm+" ]이";//(String)readDataMap.get("RESULT_MSG");
				// {0} 아닙니다. {1} 확인하세요
			...
			for(int i = 0; i < bodyListSize; i++){
				...
				*/
				...
				// 추가 저장값 설정
				bodyItem.put("JOB_SE", inJobSe);			// 업무구분
				bodyItem.put("PAY_SE", inPaySe);			// 납부구분
				bodyItem.put("REQST_YM", inReqstYm);		// 신청월
		//		bodyItem.put("REQST_SE_NM", resReqstSeNm);	// 신청 구분명 설정
				bodyItem.put("S_USER_ID", inUserId);			// 등록자ID
		//		bodyItem.put("UPDUSR_ID", inUserId);			// 수정자ID
				
				
		/*		
				java.util.Set keyset = bodyItem.keySet();
				Object[] hashkeys = keyset.toArray();
				for(int k = 0; k<hashkeys.length; k++){
					
					String key = (String)hashkeys[k];
					String value = (String)bodyItem.get(key);
					System.out.println(("::::::INFO::::::: [KEY] :: [VALUE] " + key +" :: " + value ));
				}
				System.out.println("=======================================");*/
				
								// 월별 자동이체 신청/해지정보 건별 등록
				baseDao.insert("PMS000001DAO.insertAtcngReqstInfo", bodyItem);
			...
			// footer
			Map<String, Object> footerMap = (Map<String, Object>)readDataMap.get("DATA_FOOTER");	// Footer 내용
    ...
    public String getAtcngReqstFileContents(Map inMap) throws Exception
    {
    	...
    	// 헤더구성용
    	Map<String, Object> reqstDeInfo = (Map<String, Object>)baseDao.select("PMS000001DAO.selectAtcngReqstDeInfo", inMap);
/*
    	System.out.println(inMap.get(":::::::::INFO:::::::: BODY REQST_YM :: " + "REQST_YM"));
    	System.out.println(inMap.get(":::::::::INFO:::::::: BODY JOB_SE :: " + "JOB_SE"));
    	System.out.println(inMap.get(":::::::::INFO:::::::: BODY PAY_SE :: " + "PAY_SE"));
    	System.out.println(inMap.get(":::::::::INFO:::::::: BODY VAL1 :: " + "VAL1"));
    	*/
    	// 바디구성용
    	List<Map> bodyList = (List<Map>)baseDao.list("PMS000001DAO.selectAtcngReqstList", inMap);
    	 ...
    	 */
    /*	System.out.println(":::::::::INFO:::::::: VAL1 :: " + inMap.get("VAL1"));*/
    	...
    	buffer.append(StringUtil.rpad((String)inMap.get("VAL1"), ' ', 6));	// 헤더-기관코드('2140010'로 고정)
    	buffer.append(StringUtil.rpad("0", ' ', 1));				// 헤더코드 마지막 0 붙여줌
    	...
    	buffer.append(StringUtil.rpad("", ' ', 38));				// 헤더-예비    	
    	buffer.append(CRLF);
    	...
    	/*System.out.println(":::::::::INFO:::::::: BODYLIST :: " + bodyList.size());*/
    ...
    /*		
    		System.out.println(":::::::::INFO:::::::: REQST_DE2 :: "+ reqstDe );				// 신청일자
    		System.out.println(":::::::::INFO:::::::: BANK_CODE2 :: "+ bankCode );				// 은행코드
    		System.out.println(":::::::::INFO:::::::: ACNUTNO :: "+ acnutno );					// 계좌번호
    		System.out.println(":::::::::INFO:::::::: FBS_MANAGE_NO :: "+ fbsManageNo);			// FSB관리번호
    		System.out.println(":::::::::INFO:::::::: PAYER_NO :: "+ payerNo);					// 납부자번호
    		System.out.println(":::::::::INFO:::::::: REQST_SE :: "+ reqstSe);					// 신청구분
    		System.out.println(":::::::::INFO:::::::: TRANSFR_HOPE_DE :: "+ transfrHopeDe);		//이체희망일자
    		System.out.println(":::::::::INFO:::::::: REQST_SPOT_CODE :: "+ reqstSpotCode);		// 신청지점코드
    		System.out.println(":::::::::INFO:::::::: DPSTR :: "+ dpstr);						// 예금주명
    		System.out.println(":::::::::INFO:::::::: REQST_RESULT_CODE :: "+ reqstResultCode); // 결과
    		*/
   ...
   /* 	
    	System.out.println(":::::::::::::INFO::::::::: BANK FILE BUFFER :: " + buffer.toString());*/
	...
	public void listCUD(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inDsMap != null)
			inMap = inDsMap.get(0);
		/*	
			System.out.println("::::::INFO::::::: IN_REC_YYYYMM :: " + inMap.get("IN_REC_YYYYMM") );
			System.out.println("::::::INFO::::::: JOB_SE :: " + inMap.get("JOB_SE") );
			System.out.println("::::::INFO::::::: PAY_SE " + inMap.get("PAY_SE") );*/
		
		List <Map> records;

		records = (List<Map>)baseDao.list("PMS000001DAO.SPRNT_TBPMS_ATCNG_REQ_TR_IU", inMap);		
