 ...
 * @Class Name   	: CMP020303ServiceImpl.java
 * @Description  	: 소재지별 소유자 변경이력 조회
 * @author       	: 이광원
 * @since        	: 2017. 01. 17.
 * @version      	: 1.0
 * @see          	: 
 ...
 * </pre>  
 */
@Service("CMP020303Service")
public class CMP020303ServiceImpl extends BaseService{
	
	protected Logger log = LoggerFactory.getLogger(CMP020303ServiceImpl.class);
	...
	public void thingWtnncList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("CMP020303DAO.thingWtnncList", inMap);
