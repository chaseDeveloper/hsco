 ...
 * @Class Name   	: CMP020302ServiceImpl.java
 ...
 * </pre>  
 */
@Service("CMP020302Service")
public class CMP020302ServiceImpl extends BaseService{
	
	protected Logger log = LoggerFactory.getLogger(CMP020302ServiceImpl.class);
	...
	public void thingWtnncList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("CMP020302DAO.thingWtnncList", inMap);
	...
	public void ownerPartcpntList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("CMP020302DAO.ownerPartcpntList", inMap);
