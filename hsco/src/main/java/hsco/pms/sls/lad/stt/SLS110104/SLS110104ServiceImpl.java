 ...
 * @Class Name   	: SLS110104ServiceImpl.java
...
@Service("SLS110104Service")
public class SLS110104ServiceImpl extends BaseService implements SLS110104Service {
    ...
    public void selectLadSuplyDtlsList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadSuplyDtlsList", inMap);
    ...
    public void selectLadNotLttotList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadNotLttotList", inMap);
    ...
    public void selectLadCocnrList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadCocnrList", inMap);
    ...
    public void selectLadCocnrChangeDtlsList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadCocnrChangeDtlsList", inMap);
    ...
    public void selectLadNmChangeList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadNmChangeList", inMap);
    ...
    public void selectLadOwnShipTransrSttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadOwnShipTransrSttusList", inMap);
    ...
    public void selectLadSeizrSttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadSeizrSttusList", inMap);
    ...
    public void selectLadLonSttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadLonSttusList", inMap);
    ...
    public void selectLadUnclamtSttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadUnclamtSttusList", inMap);
     ...
     */
    @SuppressWarnings({"unchecked","rawtypes"})
    public void selectLadRcivAmtList(DataSetMap tranInfo, Map<String, Object> inVar,
			Map<String, DataSetMap> inDataset, Map<String, Object> outVar,
			Map<String, DataSetMap> outDataset) throws NexaServiceException {
...
/*			String inInqireSe = (String)inMap.get("INQIRE_SE");			// 조회구분
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadRcivAmtList", inMap);
...
/*			String inInqireSe = (String)inMap.get("INQIRE_SE");			// 조회구분
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadPayList", inMap);
    ...
    public void selectLadRemndrAmtPaySttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadRemndrAmtPaySttusList", inMap);
    ...
    public void selectLadRcivDtlsRcivDtList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadRcivDtlsRcivDtList", inMap);
    ...
    public void selectLadRcivDtlsRcivAcmsltList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110104DAO.selectLadRcivDtlsRcivAcmsltList", inMap);
