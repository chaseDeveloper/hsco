 ...
 * @Class Name   	: SLS100400ServiceImpl.java
 ...
 * </pre>  
 */
@Service("SLS100400Service")
public class SLS100400ServiceImpl extends BaseService{
	...
	public void selectDecsnList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("SLS100400DAO.selectDecsnList", inMap);
	...
	public void saveDecsnList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < list.size(); x++) {
			...
			if ( rowType == DataSet.ROW_TYPE_INSERTED ){
				baseDao.insert("SLS100400DAO.DecsnListInsert", map);
			}else if(rowType == DataSet.ROW_TYPE_UPDATED ){
				baseDao.update("SLS100400DAO.DecsnListUpdate", map);
			}else if(rowType == DataSet.ROW_TYPE_DELETED ){
				baseDao.delete("SLS100400DAO.DecsnListDelete", map);
			}
		}
	} 
...
/* ***************************************************** 신규 팝업 SQL SLS100400_P01.xfdl ****************************************************** */	
	 ...
	 */ 
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public void ladCntrctCstmrList( DataSetMap tranInfo, Map<String, Object> inVar,
			Map<String, DataSetMap> inDataset, Map<String, Object> outVar,
			Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		List <Map> records = (List<Map>)baseDao.list("SLS100400DAO.ladCntrctCstmrList", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
		outDataset.put("output1", outDsMap);
	}
/* ***************************************************** 계정과목 팝업 SQL SLS100400_P02.xfdl ****************************************************** */	
	...
	public void budgetAcntRentMapngList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("SLS100400DAO.budgetAcntRentMapngList", inMap);
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps(records);
		outDataset.put("output1", outDsMap);
	}
