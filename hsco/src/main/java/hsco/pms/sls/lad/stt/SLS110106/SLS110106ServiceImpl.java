 ...
 * @Class Name   	: SLS110106ServiceImpl.java
...
@Service("SLS110106Service")
public class SLS110106ServiceImpl extends BaseService implements SLS110106Service {
    ...
    public void selectLadSuplyDtlsList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadSuplyDtlsList", inMap);
    ...
    public void selectLadNotLttotList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadNotLttotList", inMap);
    ...
    public void selectLadCocnrList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadCocnrList", inMap);
    ...
    public void selectLadCocnrChangeDtlsList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadCocnrChangeDtlsList", inMap);
    ...
    public void selectLadNmChangeList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadNmChangeList", inMap);
    ...
    public void selectLadOwnShipTransrSttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadOwnShipTransrSttusList", inMap);
    ...
    public void selectLadSeizrSttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadSeizrSttusList", inMap);
    ...
    public void selectLadLonSttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadLonSttusList", inMap);
    ...
    public void selectLadUnclamtSttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadUnclamtSttusList", inMap);
    ...
    public void selectLadRemndrAmtPaySttusList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadRemndrAmtPaySttusList", inMap);
    ...
    public void selectLadRcivDtlsRcivDtList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadRcivDtlsRcivDtList", inMap);
    ...
    public void selectLadRcivDtlsRcivAcmsltList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		resList = (List<Map>)baseDao.list("SLS110106DAO.selectLadRcivDtlsRcivAcmsltList", inMap);
