package hsco.pms.sls.com.SLS000102;
...
@Service("SLS000102Service")
public class SLS000102ServiceImpl extends BaseService implements SLS000102Service {
	...
	public void selectEtcIncmeList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("SLS000102DAO.selectEtcIncmeList", inMap);
		...
		for (int i = 0; i < listSize; i++) {
			...
			switch(rowType) {
				...
				case DataSet.ROW_TYPE_INSERTED :
					...
					// 계약정보 저장
					baseDao.insert("SLS000102DAO.insertHcntrctrInfo", map);				
					...
					//기타수입납부 등록
					baseDao.insert("SLS000102DAO.insertEtcIncmePay", map);
					...
					if("1".equals(s_DECSN_SE1)){
						...
						//baseDao.delete("SLS000102DAO.deleteEtcIncmeDecsn", map);
						baseDao.insert("SLS000102DAO.insertEtcIncmeDecsn", map);
						
						//기타수입관리 결의번호 수정
						map.put("LEV_DECSN_NO", incmeDecsnNo);
						baseDao.update("SLS000102DAO.updateDecsnNoEtcIncme1", map);
					...
					if("2".equals(s_DECSN_SE2)){
						...
						baseDao.update("SLS000102DAO.updateDecsnNoEtcIncme2", map);
					}
				...
				case DataSet.ROW_TYPE_UPDATED :
					...
					iRow += baseDao.update("SLS000102DAO.updateEtcIncmePay", map);
					
					//주택계약사업자 계약번호,고객번호 업데이트
					baseDao.update("SLS000102DAO.updateHcntrctrBsnm", map);
					...
					if( map.get("LEV_DECSN_NO") == null || "".equals(map.get("LEV_DECSN_NO").toString()) ){
						...
						if("1".equals(s_DECSN_SE1)){
							map.put("DECSN_SE", "1");
							baseDao.insert("SLS000102DAO.updateEtcIncmeDecsn", map);
						}
					}
				...
				case DataSet.ROW_TYPE_DELETED :
					...
					iRow += baseDao.delete("SLS000102DAO.deleteEtcIncme", map);
					
					baseDao.delete("SLS000102DAO.deleteEtcIncmeDecsn1", map);
					baseDao.delete("SLS000102DAO.deleteEtcIncmeDecsn2", map);
	...
	public String selectEtcIncmePayNo(Map map) {
		String seq = (String)baseDao.select("SLS000102DAO.selectEtcIncmePayNo", map);		
	...
	public String selectIncmeDecsnNo(Map map) {
		String seq = (String)baseDao.select("SLS000102DAO.selectEtcIncmeDecsnNo", map);		
	...
	public void selectDeptCodeList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("SLS000102DAO.selectDeptCodeList", inMap);
