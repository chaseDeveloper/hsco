...
public class SLS000101ServiceImpl extends BaseService implements SLS000101Service {
	...
	public void selectEtcIncmePayList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("SLS000101DAO.selectEtcIncmePayList", inMap);
		...
		for (int i = 0; i < listSize; i++) {
			...
			switch(rowType) {
				...
				case DataSet.ROW_TYPE_INSERTED :
					...
					//기타수입납부 등록
					baseDao.insert("SLS000101DAO.insertEtcIncmePay", map);
					break;
				case DataSet.ROW_TYPE_UPDATED :
					iRow += baseDao.update("SLS000101DAO.updateEtcIncmePay", map);
					break;
				case DataSet.ROW_TYPE_DELETED :
					iRow += baseDao.delete("SLS000101DAO.deleteEtcIncmePay", map);
					break;
			}
		}
	...
	public String selectEtcIncmePayNo(Map map) {
		String seq = (String)baseDao.select("SLS000101DAO.selectEtcIncmePayNo", map);		
	...
	public String selectEtcIncmeDecsnNo(Map map) {
		String seq = (String)baseDao.select("SLS000101DAO.selectEtcIncmeDecsnNo", map);		
	...
	public void selectDeptCodeList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("SLS000101DAO.selectDeptCodeList", inMap);
