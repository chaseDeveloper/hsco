 ...
 * @Class Name   	: SancFormID01ServiceImpl.java
 * @Description  	: 
 * @author       	: 강노구
 * @since        	: 2017. 12. 15.
 * @version      	: 1.0
 ...
 * </pre>
 */
public class SancFormID01ServiceImpl implements SancAfterProcService {
	
	@Override
	public void sancAfterProc_01(BaseDao baseDao, Map<String, Object> pMap) {
		baseDao.update("SancDAO.SP_M_01_1", pMap);
	}
	...
	public void sancAfterProc_05(BaseDao baseDao, Map<String, Object> pMap) {
		baseDao.update("SancDAO.SP_M_01_5", pMap);
	}
