...
@Repository("BioStarDao")
public class BioStarDao {
	
	@Resource(name="bioSqlExcutor")
	protected BioSqlExcutor sqlExcutor;

	protected BioStarDao() {
	}
	
	@Deprecated
	@Resource(name = "sqlMapClient4MsSql")
