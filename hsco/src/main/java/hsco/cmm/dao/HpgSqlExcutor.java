 ...
 * @Description  	: 홈페이지 관리자용 SQL 실행 Class
 * @author       	: 정윤원
 * @since        	: 2015. 9. 16.
 * @version      	: 1.0
 * @see          	: 
...
@Repository("HpgSqlExcutor")
public class HpgSqlExcutor extends SqlMapClientDaoSupport {
	...
	public <T> T execQuery( String function, String queryId, Class paramClass[], 
		...
		try {
			...
			if(bLog) {      	
	        	...
	        	logSvc.putLog(this, queryId, parameterObject, logMap);
			}
