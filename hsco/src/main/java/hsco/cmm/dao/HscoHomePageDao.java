 ...
 * 
 * <pre>
 * @Project Name 	: 화성도시공사 삼두회계시스템 연동용 DAO 클래스
 * @Class Name   	: BioStartDao.java
 * @Description  	: 
 * @author       	: 홍길동
 * @since        	: 2017. 5. 8.
 * @version      	: 1.0
 * @see          	: 
 * @COPYRIGHT (c) 2017 Nanum, Inc. All Right Reserved.
 * <pre>
 * ------------------------------------------------------------------
...
@Repository("hscoHomePageDao")
public class HscoHomePageDao {
	
	@Resource(name="hscoHomePageSqlExcutor")
	protected HscoHomePageSqlExcutor sqlExcutor;

	protected HscoHomePageDao() {
	}
	
	@Deprecated
	@Resource(name = "sqlMapClient4MsSql_Homepage")
