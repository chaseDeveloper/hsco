 ...
 * 
 * <pre>
 * @Project Name 	: 화성도시공사 근태기 연동용 DAO 클래스
...
@Repository("handyGWDao")
public class HandyGWDao {
	
	@Resource(name="handyGWSqlExcutor")
	protected HandyGWSqlExcutor sqlExcutor;

	protected HandyGWDao() {
	}
	
	@Deprecated
	@Resource(name = "sqlMapClient4HandyGW")
