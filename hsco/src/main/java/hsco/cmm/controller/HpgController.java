...
import hsco.cmm.service.HpgService;
/**
 * 
 * <pre>
 * @Project Name 	: 화성도시공사 차세대정보시스템
 * @Class Name   	: HpgController.java
 * @Description  	: 홈페이지 관리자를 위한 데이터 소스 도입으로 컨트롤러를 추가함.
 * @author       	: 정윤원
 * @since        	: 2016. 3. 29.
 * @version      	: 1.0
 * @see          	: 
...
public class HpgController  {
	...
	public ModelAndView execService(HpgService serviceClass, String serviceName, 
			NexacroMapDTO xpDto, ModelAndView mav)
		throws Exception
	{
		if(log.isInfoEnabled())
		    log.info("execService started!");
		Class<HpgService> serviceImpl = (Class<HpgService>)serviceClass.getClass();
		...
		//HpgService HpgService = serviceImpl.cast(serviceClass);
