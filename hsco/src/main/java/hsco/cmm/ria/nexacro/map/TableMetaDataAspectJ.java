...
import hsco.cmm.ria.nexacro.Context;
...
public class TableMetaDataAspectJ {
	...
	Logger logger = LoggerFactory.getLogger(TableMetaDataAspectJ.class);
	...
	//@Before("within(egovframework.rte.psl.orm.ibatis.support.SqlMapClientDaoSupport)")
