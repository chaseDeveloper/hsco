package hsco.egov.com.cmm.service.impl;
...
public class FileManageDAO extends EgovComAbstractDAO {
	...
	public List<EgovMap> selectFileInfs(FileVO vo) throws Exception {
		return (List<EgovMap>) list("FileManageDAO.selectFileList", vo);
	}
