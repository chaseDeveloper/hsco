...
@Service("SAL010112Service")
public class SAL010112ServiceImpl extends BaseService {
	...
	public void selectDeptList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		List<Map> records = (List<Map>) baseDao.list("SAL010112DAO.selectDeptList", inMap);
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_INSERTED:
					map.put("HIST_SE", "I");
					baseDao.insert("SAL010112DAO.insertDept", map);
					break;
				case DataSet.ROW_TYPE_UPDATED:
					map.put("HIST_SE", "U");
					baseDao.update("SAL010112DAO.updateDept", map);
					break;
				case DataSet.ROW_TYPE_DELETED:
					map.put("HIST_SE", "D");
					baseDao.delete("SAL010112DAO.deleteDept", map);
					break;
			}
		}
		return iRow;
