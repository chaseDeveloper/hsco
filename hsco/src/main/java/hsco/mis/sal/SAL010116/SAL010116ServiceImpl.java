 ...
 * @Class Name   	: SAL010116ServiceImpl.java
...
@Service("SAL010116Service")
public class SAL010116ServiceImpl extends BaseService {
	...
	public void selectComputDtlsList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		List<Map> records  = (List<Map>) baseDao.list("SAL010116DAO.selectIndiComputDtlsList", inMap);
		List<Map> records2 = (List<Map>) baseDao.list("SAL010116DAO.selectDeptComputDtlsList", inMap);
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_INSERTED:
					// 저장
					baseDao.insert("SAL010116DAO.computDtlsCU", map);
					break;
			}
		}
	}
	...
	public void computDtlsListD(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		baseDao.delete("SAL010116DAO.computDtlsD", inMap);
