 ...
 * @Class Name      : BDG050202ServiceImpl.java
 * @Description     : 
 * @author          : 정윤원
 * @since           : 2015. 9. 21.
 * @version         : 1.0
 ...
 * </pre>
 */
@Service("BDG050202Service")
public class BDG050202ServiceImpl extends BaseService implements BDG050202Service {
    ...
    public void selectBudgetExcutPlan(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
        ...
        outDsMap.setRowMaps((List<Map>) baseDao.list("BDG050202DAO.selectBudgetExcutPlan", inMap));
