 ...
 * @Class Name   	: ACC040204ServiceImpl.java
 * @Description  	: 카드별집계관리 ServiceImpl 클래스 
 * @author       	: 이상명
 * @since        	: 2015. 07. 16.
 * @version      	: 1.0
 * @see          	: 
 ...
 * </pre>  
 */
@Service("ACC040204Service")
public class ACC040204ServiceImpl extends BaseService {

	protected Logger log = LoggerFactory.getLogger(ACC040204ServiceImpl.class);
	
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public void catsApprovalList(DataSetMap tranInfo,
        ...
        outDsMap.setRowMaps((List<Map>) baseDao.list("ACC040204DAO.catsApprovalList", inMap));
    ...
    public void cardList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
        ...
        outDsMap1.setRowMaps((List<Map>) baseDao.list("ACC040204DAO.cardList", inMap));
