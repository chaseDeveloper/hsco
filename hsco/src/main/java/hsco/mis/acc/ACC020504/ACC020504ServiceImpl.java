 ...
 * @Class Name   	: ACC020504ServiceImpl.java
 ...
 * </pre>  
 */
@Service("ACC020504Service")
public class ACC020504ServiceImpl extends BaseService {

protected Logger log = LoggerFactory.getLogger(ACC020504ServiceImpl.class);
	...
	public void incExpElseCashMastrList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records;
		records = (List<Map>)baseDao.list("ACC020504DAO.incExpElseCashMastrList", inMap);		
	...
	public void incExpElseCashDetailList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records;
		records = (List<Map>)baseDao.list("ACC020504DAO.incExpElseCashDetailList", inMap);		
			...
			for(Map map : input2.getRowMaps()) {
				...
				switch(rowType) {
					case DataSet.ROW_TYPE_DELETED :
						iRow += baseDao.delete("ACC020504DAO.incExpElseCashDetailD", map);
						break;
				    default:
				    	break;
				}
			...
			for(Map map : input1.getRowMaps()) {
				...
				switch(rowType) {
					case DataSet.ROW_TYPE_INSERTED :
						key = (String) baseDao.select("ACC020504DAO.incExpElseCashMastrPk"); 
						map.put("SN", key);
						baseDao.insert("ACC020504DAO.incExpElseCashMastrC", map);
						break;
					case DataSet.ROW_TYPE_UPDATED :
						iRow += baseDao.update("ACC020504DAO.incExpElseCashMastrU", map);
						break;
					case DataSet.ROW_TYPE_DELETED :
						iRow += baseDao.delete("ACC020504DAO.incExpElseCashMastrD", map);
						break;
				    default:
				    	break;
				}
			...
			for(Map map : input2.getRowMaps()) {
				...
				switch(rowType) {
					case DataSet.ROW_TYPE_INSERTED :
						...
						baseDao.insert("ACC020504DAO.incExpElseCashDetailC", map);
						break;
					case DataSet.ROW_TYPE_UPDATED :
						iRow += baseDao.update("ACC020504DAO.incExpElseCashDetailU", map);
						break;
				    default:
				    	break;
				}
	...
	public void incExpSyfd(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
        ...
        // 이월처리
		baseDao.update("ACC020504DAO.incExpSyfd", inMap);
	...
	public void selectAcnutList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("ACC020504DAO.selectAcnutList");		
    ...
    public void selectAtchFile( DataSetMap tranInfo, Map<String, Object> inVar,
        ...
        List <Map> records1 = (List<Map>)baseDao.list("ACC020504DAO.selectAtchFile", inMap);
