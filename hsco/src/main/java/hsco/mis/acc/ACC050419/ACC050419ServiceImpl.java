 ...
 * @Class Name      : ACC050419ServiceImpl.java
 * @Description     : 
 * @author          : 정윤원
 * @since           : 2015. 11. 17.
 * @version         : 1.0
 ...
 * </pre>
 */
@Service("ACC050419Service")
public class ACC050419ServiceImpl extends BaseService {

    protected Logger     log = LoggerFactory.getLogger(ACC050419ServiceImpl.class);
    ...
    public void select(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
        ...
        outDsMap.setRowMaps((List<Map>) baseDao.list("ACC050419DAO.select", inMap));
