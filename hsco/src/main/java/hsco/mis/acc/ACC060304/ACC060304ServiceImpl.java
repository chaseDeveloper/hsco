 ...
 * @Class Name      : ACC060304ServiceImpl.java
 * @Description     : 
 * @author          : 정윤원
 * @since           : 2015. 11. 25.
 * @version         : 1.0
 ...
 * </pre>
 */
@Service("ACC060304Service")
public class ACC060304ServiceImpl extends BaseService {

    protected Logger     log = LoggerFactory.getLogger(ACC060304ServiceImpl.class);
    ...
    public void select(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
        ...
        outDsMap.setRowMaps((List<Map>) baseDao.list("ACC060304DAO.select", inMap));
