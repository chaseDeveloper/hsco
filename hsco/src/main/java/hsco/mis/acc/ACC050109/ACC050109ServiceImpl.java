 ...
 * &#64;Class Name   	: ACC050109ServiceImpl.java
 * &#64;Description  	: 지출결의분개
 * &#64;author       	: 정 민
 * &#64;since        	: 2017. 11. 28.
 * &#64;version      	: 1.0
 ...
 * </pre>
 */
@Service("acc050109Service")
public class ACC050109ServiceImpl extends BaseService {
	...
	public void selectDsnList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset,
		...
		// 결의내역
		List<Map> records1 = (List<Map>) baseDao.list("ACC050109DAO.incDsnList", inMap);
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public void selectChitList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset,
			Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		// 분개
		inMap.put("CHIT_TY", 1);
		List<Map> records1 = (List<Map>) baseDao.list("ACC050109DAO.chitDetailList", inMap);
		List<Map> records2 = (List<Map>) baseDao.list("ACC050109DAO.chitMastrR", inMap);

		// 분개확정
		inMap.put("CHIT_TY", 2);
		List<Map> records3 = (List<Map>) baseDao.list("ACC050109DAO.chitDetailList", inMap);
		List<Map> records4 = (List<Map>) baseDao.list("ACC050109DAO.chitMastrR", inMap);
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Transactional
	public void saveChitList(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset,
			Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		if (input1.size() > 0) {
			...
			switch (mastrRowType) {
			case DataSet.ROW_TYPE_DELETED:
				baseDao.delete("ACC050103DAO.chitMastrD", mastrMap);
				break;
			default:
				break;
			}
	...
	public void incmeSlipI( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inDsMap != null) {
			inMap = inDsMap.get(0);
			baseDao.update("ACC050109DAO.incmeSlipI", inMap);
