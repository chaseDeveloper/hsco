 ...
 * @Class Name   	: ACC050301ServiceImpl.java
 ...
 * </pre>  
 */
@Service("ACC050301Service")
public class ACC050301ServiceImpl extends BaseService {

	protected Logger log = LoggerFactory.getLogger(ACC050301ServiceImpl.class);
...
//		}
		...
		outDsMap.setRowMaps((List<Map>) baseDao.list("ACC050301DAO.fnnrSttusListIfrs", inMap));
