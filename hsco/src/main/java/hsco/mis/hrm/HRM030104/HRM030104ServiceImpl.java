 ...
 * @Class Name   	: HRM030104ServiceImpl.java
 * @Description  	: 
 * @author       	: 정윤원
 * @since        	: 2015. 11. 27
 * @version      	: 1.0
 ...
 * </pre>
 */
@Service("HRM030104Service")
public class HRM030104ServiceImpl extends BaseService {
	...
	public void select(DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		outDsMap.setRowMaps((List<Map>) baseDao.list("HRM030104DAO.select", inMap));
		...
		for (int x = 0; x < list.size(); x++) {
			...
			switch (rowType) {
				case DataSet.ROW_TYPE_UPDATED:
					baseDao.update("HRM030104DAO.update", map);
					break;
			}
		}
	}
