 ...
 * @Class Name   	: HRM060201T02ServiceImpl.java
 * @Description  	: 
 * @author       	: 박병일
 * @since        	: 2015. 11. 03.
 * @version      	: 1.0
 ...
 * </pre>  
 */
@Service("HRM060201T02Service")
public class HRM060201T02ServiceImpl extends BaseService implements HRM060201T02Service {
	...
	public void selectList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("HRM060201T02DAO.selectList", inMap);		
	...
	public int mainCUD( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_DELETED :	
					baseDao.delete("HRM060201T02DAO.mainD", map);
					break;
			}
		}
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED :	
					baseDao.insert("HRM060201T02DAO.mainC", map);
					break;
					
				case DataSet.ROW_TYPE_UPDATED :
					baseDao.update("HRM060201T02DAO.mainU", map);
					break;
			}				
		}
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED :	
					baseDao.insert("HRM060201T02DAO.detailC", map);
					break;
					
				case DataSet.ROW_TYPE_UPDATED :
					baseDao.update("HRM060201T02DAO.detailU", map);
					break;
					
				case DataSet.ROW_TYPE_DELETED :	
					baseDao.delete("HRM060201T02DAO.detailD", map);
					break;			
			}				
		}
		return iRow;		
	...
	public void detailR( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("HRM060201T02DAO.detailR", inMap);		
	...
	public int bsisC( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		String existAt = (String) baseDao.select("HRM060201T02DAO.existAt", map);
		
		if(existAt.equals("0")) {
			throw new NexaServiceException("errors.없음.요청", "생성된 자료가|직전차수 정보를");
		}
		else {
			baseDao.delete("HRM060201T02DAO.mainD", map); //전체삭제
			baseDao.insert("HRM060201T02DAO.bsisC", map);
		}
