 ...
 * @Class Name   	: ACH020402ServiceImpl.java
 * @Description  	: 
 * @author       	: 정 민
 * @since        	: 2017. 07. 26.
 * @version      	: 1.0
 ...
 * </pre>  
 */
@Service("ACH020402Service")
public class ACH020402ServiceImpl extends BaseService implements ACH020402Service {
	
	protected Logger log = LoggerFactory.getLogger(ACH020402ServiceImpl.class);
	...
	public void selectKPIInfo( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020402DAO.selectKPIInfo", inMap));
	...
	public void selectRefrnList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020402DAO.selectRefrnList", inMap));
	...
	public void selectEvlEmpList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020402DAO.selectEvlEmpList", inMap));
	...
	public void saveEmpTlphonKdDgree(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < listSize; x++) {
		    ...
		    case DataSet.ROW_TYPE_UPDATED:
		    	baseDao.insert("ACH020402DAO.evlEmpCU", map);
		        break;
		    case DataSet.ROW_TYPE_DELETED:
		        baseDao.delete("ACH020402DAO.evlEmpD", map);
		        delFlag = true;
		        break;
		    }
		}
