 ...
 * @Class Name   	: ACH020401ServiceImpl.java
 * @Description  	: 
 * @author       	: 정 민
 * @since        	: 2017. 07. 26.
 * @version      	: 1.0
 ...
 * </pre>  
 */
@Service("ACH020401Service")
public class ACH020401ServiceImpl extends BaseService implements ACH020401Service {
	
	protected Logger log = LoggerFactory.getLogger(ACH020401ServiceImpl.class);
	...
	public void selectKPIInfo( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020401DAO.selectKPIInfo", inMap));
	...
	public void selectRefrnList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020401DAO.selectRefrnList", inMap));
	...
	public void selectEvlEmpList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020401DAO.selectEvlEmpList", inMap));
	...
	public void saveEmpTlphonKdDgree(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < listSize; x++) {
		    ...
		    case DataSet.ROW_TYPE_UPDATED:
		    	baseDao.insert("ACH020401DAO.evlEmpCU", map);
		        break;
		    case DataSet.ROW_TYPE_DELETED:
		        baseDao.delete("ACH020401DAO.evlEmpD", map);
		        delFlag = true;
		        break;
		    }
		}	
