 ...
 * @Class Name   	: ACH020404ServiceImpl.java
 * @Description  	: 
 * @author       	: 정 민
 * @since        	: 2017. 08. 01.
 * @version      	: 1.0
 ...
 * </pre>  
 */
@Service("ACH020404Service")
public class ACH020404ServiceImpl extends BaseService implements ACH020404Service {
	
	protected Logger log = LoggerFactory.getLogger(ACH020404ServiceImpl.class);
	...
	public void selectKPIInfo( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020404DAO.selectKPIInfo", inMap));
	...
	public void selectRefrnList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020404DAO.selectRefrnList", inMap));
	...
	public void selectEvlEmpList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		DataSetMap outDsMap = new DataSetMap();
		outDsMap.setRowMaps((List<Map>)baseDao.list("ACH020404DAO.selectEvlEmpList", inMap));
	...
	public void saveEmpTlphonKdDgree(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < listSize; x++) {
		    ...
		    case DataSet.ROW_TYPE_UPDATED:
		    	baseDao.insert("ACH020404DAO.evlEmpCU", map);
		        break;
		    case DataSet.ROW_TYPE_DELETED:
		        baseDao.delete("ACH020404DAO.evlEmpD", map);
		        delFlag = true;
		        break;
		    }
		}
		...
		if(listSize > 0 && delFlag) {
			baseDao.delete("ACH020404DAO.qyevalDstbAcmsltD", list2.get(0));
		}
