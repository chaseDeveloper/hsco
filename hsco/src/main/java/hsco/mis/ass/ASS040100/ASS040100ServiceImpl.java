 ...
 * </pre>  
 */
@Service("ass040100Service")
public class ASS040100ServiceImpl extends BaseService {
	...
	public void assetsMastrList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List<Map>)baseDao.list("ASS040100DAO.assetsMastrList", inMap);		
	...
	public void assetsClList(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("ASS040100DAO.assetsClList", inMap);		
