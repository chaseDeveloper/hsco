package hsco.mis.ass.ASS011100;
 ...
 * @Class Name      : ASS011100Service.java
...
@Service("ASS011100Service")
public class ASS011100ServiceImpl extends BaseService {
	...
	public void selectThngReciptManageTmpr( DataSetMap tranInfo, Map<String, Object> inVar, Map<String, DataSetMap> inDataset, Map<String, Object> outVar, Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		outDsMap.setRowMaps((List<Map>) baseDao.list("ASS011100DAO.selectThngReciptManageTmpr", inMap));
		...
		for (int x = 0; x < list1.size(); x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED:
					baseDao.insert("ASS011100DAO.insertThngReciptManageTmpr", map);
					break;
				case DataSet.ROW_TYPE_UPDATED :
					baseDao.update("ASS011100DAO.updateThngReciptManageTmpr", map);
					break;
				case DataSet.ROW_TYPE_DELETED:
					...
					baseDao.delete("ASS011100DAO.deleteThngReciptManageTmpr", map);
					break;
			}
		}
