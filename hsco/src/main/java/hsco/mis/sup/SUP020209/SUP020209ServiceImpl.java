 ...
 * @Class Name   	: SUP020209ServiceImpl.java
 * @Description  	: 제안자료조회하는 서비스 구현체 클래스
 * @author       	: 양성모
 * @since        	: 2015. 11. 06.
 * @version      	: 1.0
 * @see          	: 
...
@Service("sup020209Service")
public class SUP020209ServiceImpl extends BaseService implements SUP020209Service {
	...
	public void selectPropseMastrList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("SUP020209DAO.selectPropseMastrList", inMap);
	...
	public void selectPropseSubList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records1 = (List<Map>)baseDao.list("SUP020209DAO.selectPropsePropsrList", inMap);
		records2 = (List<Map>)baseDao.list("SUP020209DAO.selectPropseExmntDeptList", inMap);
	...
	public void selectPropseOprtnList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records1 = (List<Map>)baseDao.list("SUP020209DAO.selectPropsePropsrList", inMap);
		records2 = (List<Map>)baseDao.list("SUP020209DAO.selectPropseExmntDeptList", inMap);
		records3 = (List<Map>)baseDao.list("SUP020209DAO.selectPropseOprtnList", inMap);	// 제안실시성과 조회
	...
	public void selectExmntOpinio( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records1 = (List<Map>)baseDao.list("SUP020209DAO.selectExmntOpinio", inMap);
