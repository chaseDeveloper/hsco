 ...
 * @Class Name   	: SUP040200Controller.java
 * @Description  	: 
 * @author       	: 양성모
 * @since        	: 2015. 10. 15.
 * @version      	: 1.0
 ...
 */
@Controller
public class SUP040200Controller extends BaseContoller {
	
	protected Logger log = LoggerFactory.getLogger(this.getClass());	
	
	@Resource(name="sup040200Service")
	SUP040200ServiceImpl sup040200Service;
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/hsco/mis/sup/SUP040200/selectBodMasterPopUp.do") 
	public ModelAndView selectBodMasterPopUp(NexacroMapDTO xpDto, Model model) throws Exception {
		
		ModelAndView mav = new ModelAndView("nexacroMapView");
		
		execService(sup040200Service, "selectBodMasterPopUp", xpDto, mav);
     ...
     * @throws Exception
     */
    @RequestMapping("/hsco/mis/sup/SUP040200/selectBodNmstList.do")
    public ModelAndView selectBodNmstList(NexacroMapDTO xpDto, Model model) throws Exception {
        ModelAndView mav = new ModelAndView("nexacroMapView");

        execService(sup040200Service, "selectBodNmstList", xpDto, mav);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/hsco/mis/sup/SUP040200/selectBodMaster.do") 
	public ModelAndView selectBodMaster(NexacroMapDTO xpDto, Model model) throws Exception {
		
		ModelAndView mav = new ModelAndView("nexacroMapView");
		
		execService(sup040200Service, "selectBodMaster", xpDto, mav);
     ...
     * @throws Exception
     */
    @RequestMapping("/hsco/mis/sup/SUP040200/selectFileList.do")
    public ModelAndView selectFileList(NexacroMapDTO xpDto, Model model) throws Exception {
        ModelAndView mav = new ModelAndView("nexacroMapView");

        execService(sup040200Service, "selectFileList", xpDto, mav);
     ...
     * @throws Exception
     */
    @RequestMapping("/hsco/mis/sup/SUP040200/saveNewFileSn.do")
    public ModelAndView saveNewFileSn(NexacroMapDTO xpDto, Model model) throws Exception {
        ModelAndView mav = new ModelAndView("nexacroMapView");

        execService(sup040200Service, "saveNewFileSn", xpDto, mav);
    ...
    @RequestMapping("/hsco/mis/sup/SUP040200/approve.do")
...
//        map.put("DIV",     "570");      // 001 : 이사회관리
        ...
        execService(sup040200Service, "approveCUD", xpDto, mav);    // 이사회관리 테이블에 전자결재번호 업데이트 수행
