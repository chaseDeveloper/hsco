 ...
 * @Class Name   	: SUP040100ServiceImpl.java
...
@Service("sup040100Service")
public class SUP040100ServiceImpl extends BaseService implements SUP040100Service {
	...
	public void selectBodNmstList( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		records = (List<Map>)baseDao.list("SUP040100DAO.selectBodNmstList", inMap);
	...
	public int saveBodNmst( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < listSize; x++) {
			...
			switch(rowType) {
				case DataSet.ROW_TYPE_INSERTED :
					baseDao.insert("SUP040100DAO.saveBodNmstC", map);
					break;
				case DataSet.ROW_TYPE_UPDATED :
					iRow += baseDao.update("SUP040100DAO.saveBodNmstU", map);
					break;
				case DataSet.ROW_TYPE_DELETED :
					iRow += baseDao.delete("SUP040100DAO.saveBodNmstD", map);
					        baseDao.delete("SUP040100DAO.saveBodAtdrnD", map);
					break;
			}	
		}
        ...
        baseDao.update("SUP040100DAO.saveBodMastrU", map);
	...
	public void atchCUD( DataSetMap tranInfo, Map<String, Object> inVar,
		...
		for (int x = 0; x < listSize; x++) {
			...
			if(upResult != null){
				...
				baseDao.update("SUP040100DAO.atchCUD", map);
    ...
    public void atchDelete(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		if (inDsMap != null){
			...
			String inFileSn = (String)inMap.get("FILE_SN");	// 파일일련번호
				...
				// 임원관리 첨부파일일련번호 삭제
				baseDao.update("SUP040100DAO.atchDelete", inMap);
				...
				if(hasAtchFile){
				 ...
				 DataSetMap outDsMap = new DataSetMap();
			     outDsMap.setRowMaps((List<Map>) baseDao.list("SUP040100DAO.selectFile", inMap));
			     outDataset.put("output1", outDsMap);
