 ...
 * </pre>
 */
@Service("SYM020200Service")
public class SYM020200ServiceImpl extends BaseService implements SYM020200Service {
	
	protected Logger log = LoggerFactory.getLogger(SYM020200ServiceImpl.class);
	...
	public void getListDept(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List)baseDao.list("SYM020200DAO.getListDept", inMap);
	...
	public void getListGrp(DataSetMap tranInfo, Map<String, Object> inVar,
		...
		List <Map> records = (List)baseDao.list("SYM020200DAO.getListGrp", inMap);
	...
	public void getListUser(DataSetMap tranInfo,
		...
		List <Map> records = (List)baseDao.list("SYM020200DAO.getListUser", inMap);
	...
	public int SYM020200CUD(DataSetMap tranInfo, Map<String, Object> inVar,
			Map<String, DataSetMap> inDataset, Map<String, Object> outVar,
			Map<String, DataSetMap> outDataset) throws NexaServiceException {
		...
		for (int x = 0; x < list.size(); x++) {
			...
			switch(rowType) {
				...
				case DataSet.ROW_TYPE_DELETED :
					baseDao.delete("SYM020200DAO.SYM020200D", map);
