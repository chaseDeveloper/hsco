...
public class BDGJOB0002 implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
    	...
    	// 메시지 전송
        int updateCnt = batchDao.update("BDGJOB0002.blceCyfd", map);
		
    	System.out.println("[BDGJOB0002 잔액이월 결과]" + updateCnt + "건의 데이터가 업데이트 되었습니다.");
  
        context.setResult(0); // Job 정상처리 상태(0) 반드시 넣어주세요.  논리적인 메시지는 if 문으로 분기하고, 텍스트를 설정하세요.
        
        System.out.println("##### Job BDGJOB0002[{}] {}.execute() finished! " + jobName + "  :  " + jobClass);
